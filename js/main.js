...
(function() {
    ...
    function initHeroSlider() {
        ...
        heroSlider.setAttribute('aria-label', 'DevHelper screenshots slideshow');
        ...
        if (downloadBtn) {
            downloadBtn.addEventListener('click', function(e) {
                ...
                if (downloadUrl) {
                    ...
                    window.open('https://github.com/hengfeiyang/devhelper/releases/latest', '_blank');
                }
                ...
                if (typeof gtag !== 'undefined') {
                    gtag('event', 'download_attempt', {
                        ...
                        'event_label': 'devhelper_download'
                    });
                }
            });
        }
