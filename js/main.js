...
(function () {
  ...
  const TOOLS = [
    ...
    { n: '03', cat: 'Convert',  slug: 'timestamp',         name: 'Timestamp',
    ...
    { n: '14', cat: 'Generate', slug: 'uuid',              name: 'UUID',
